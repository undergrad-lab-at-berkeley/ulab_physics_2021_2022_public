...
How can we derive the normal distribution. Idea: (1) errors are symmetric about the true value, so it is the mean, (2) the larger the error, i.e. farther from the mean, the less probable we are to measure. Can we express this as a differential equation for the probability density?
