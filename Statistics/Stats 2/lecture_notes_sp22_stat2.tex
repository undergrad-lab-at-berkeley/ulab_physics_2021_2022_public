...
\begin{enumerate}
	...
	\item The ideal value of $ \chi^2_r $ is not 0: no residuals and a perfect fit. This is because $ \sigma_i $ is never 0, we EXPECT our measurements to deviate by a reasonable amount and not perfectly match our model. The deviation that WE EXPECT in $\chi^2  $ is 1 per dof.
