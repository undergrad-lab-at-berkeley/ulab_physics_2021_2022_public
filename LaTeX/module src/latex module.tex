...
\end{verbatim}
	...
	\part Let's go back and add in the citations with \href{https://www.overleaf.com/learn/latex/Bibliography_management_with_bibtex}{Bibtex}. The \verb|ref.bib| file has been provided for you. Hint: before the end of the document (\verb|\end{document}|), include the following commands:
	...
	\textbf{Submission:} Congrats on your completing your LaTeX report! Hopefully this module has demonstrated that LaTeX is a great way to quickly typeset organized, well-formatted, and professional-looking documents. 
